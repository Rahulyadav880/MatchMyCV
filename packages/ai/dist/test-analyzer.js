...
const analyzer = new ResumeAnalyzer(provider);
const resume = {
    personalInfo: {
    ...
    projects: [
        {
            name: "Affnet-v2 - Property Rental & Listing Platform",
            description: "Developed the backend architecture and designed RESTful APIs to enable secure communication between the frontend and server. Implemented database integration, authentication, validation, and robust error handling to improve application security, reliability, and data management. Utilized Git and GitHub for version control and collaborative development.",
            technologies: [
                "TypeScript",
                "Node.js",
                "Express.js",
        ...
        {
            name: "SocketTalk - Real-Time Chat Application",
            description: "Built a real-time chat application using React, Node.js, TypeScript and WebSockets to enable instant room-based messaging. Implemented WebSocket-based JSON communication and organized the project as a TurboRepo monorepo for efficient code sharing and maintainability. Deployed the frontend on Vercel and the backend on Render.",
            technologies: [
                "React",
                "Node.js",
                "TypeScript",
